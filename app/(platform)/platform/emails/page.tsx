    ...
    <div className="p-8 max-w-7xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="p-6 rounded-3xl bg-white/[0.02] border border-white/5 space-y-4">
            ...
            <div>
                <h4 className="text-white font-bold uppercase text-[10px] tracking-widest leading-none mb-1">Health Status</h4>
        ...
        <div className="p-6 rounded-3xl bg-white/[0.02] border border-white/5 space-y-4">
            ...
            <div>
                <h4 className="text-white font-bold uppercase text-[10px] tracking-widest leading-none mb-1">Idempotency Layer</h4>
        ...
        <div className="p-6 rounded-3xl bg-white/[0.02] border border-white/5 space-y-4">
            ...
            <div>
                <h4 className="text-white font-bold uppercase text-[10px] tracking-widest leading-none mb-1">Template Engine</h4>
            ...
            {logs.length === 0 ? (
              ...
              logs.map(log => (
                <TableRow key={log.id} className="border-white/5 hover:bg-white/[0.02] transition-colors group">
                  ...
                  <TableCell>
                    <div>
                      <p className="font-bold text-white tracking-tight">{log.user.name || "Anonymous"}</p>
                      <p className="text-[10px] text-muted-foreground">{log.user.email}</p>
                    </div>
                  </TableCell>
                  <TableCell className="text-sm text-white/70 max-w-[200px] truncate">
                    {log.subject}
                  </TableCell>
