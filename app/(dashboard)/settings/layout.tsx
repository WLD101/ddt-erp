...
import { Settings, Users, ShieldCheck, MapPin, CreditCard, Receipt } from "lucide-react";
...
export default function SettingsLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex h-full w-full max-w-7xl mx-auto overflow-hidden">
      ...
      <aside className="w-64 flex-shrink-0 border-r border-white/5 bg-black/10 backdrop-blur-md p-6 overflow-y-auto hidden md:block">
      ...
      <main className="flex-1 min-w-0 overflow-y-auto bg-black/5">
