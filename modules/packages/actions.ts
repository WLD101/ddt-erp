...
export async function ensureDefaultPackages() {
  for (const planId of PLAN_ORDER) {
    ...
    const defaultMeta = {
      ...
      monthlySalesEntryLimit: plan.limits.maxMonthlySalesEntries,
      dailyExportLimit: plan.limits.maxDailyExports,
      monthlyAssistantActionLimit: plan.limits.maxMonthlyAssistantActions,
      storageGbLimit: plan.limits.maxStorageGb,
      monthlyApiRequestLimit: plan.limits.maxApiRequestsMonthly,
      integrationsLimit: plan.limits.maxIntegrations,
      modules: plan.includedModules,
      features: plan.features,
      supportLabel: plan.supportLabel,
      tagline: plan.tagline,
      originalMonthlyPrice: plan.price.monthly,
      discountedMonthlyPrice: plan.price.monthly,
      monthlyDiscountLabel: null,
      originalYearlyPrice: plan.price.annualEquivalent,
      discountedYearlyPrice: plan.price.yearly,
      yearlyDiscountLabel: plan.price.savingsPercent ? `SAVE ${plan.price.savingsPercent}%` : null,
      discountEnabled: plan.price.promoEnabled,
      ...
      discountCountdownReady: plan.price.discountCountdownReady,
